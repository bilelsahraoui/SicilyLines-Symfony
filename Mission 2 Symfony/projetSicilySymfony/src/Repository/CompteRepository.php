...
class CompteRepository extends ServiceEntityRepository
{
    ...
    public function updateUser(int $userId, string $password, string $username)
    {
        $req = "update u from App\Entity\User u set password=$password where u.id=$userId, set username=$username where u.id=$userId";
